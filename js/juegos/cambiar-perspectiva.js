  ...
  function render() {
    ...
    contenedor.innerHTML = `
      <div style="width:min(94vw,460px);margin:0 auto;text-align:center;">
        ...
        <p style="color:var(--text-mid);margin-bottom:10px;font-size:0.9rem;">Pensá en al menos dos explicaciones posibles, distintas a la primera que se te ocurrió.</p>
