  ...
  function render() {
    ...
    contenedor.innerHTML = `
      <div style="width:min(94vw,460px);margin:0 auto;text-align:center;">
        ...
        <div class="lector-fila"><p style="color:var(--text-mid);font-size:0.9rem;">Reescribilo de una forma más flexible o realista.</p>${Lector.boton(`${orden[i]}. Reescribilo de una forma más flexible o realista.`)}</div>
