(function () {
  ...
  ctx.lineWidth = 5; ctx.lineCap = "round"; ctx.strokeStyle = COLORES[0];
  ...
  document.getElementById("btnLimpiarEmo").addEventListener("click", () => ctx.clearRect(0, 0, canvas.width, canvas.height));
