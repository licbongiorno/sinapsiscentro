...
const JUEGOS = [
  ...
  // ═══════ Motor genérico: reaccion-tematica ═══════
  { id: "reflejos-espera-el-verde", nombre: "Esperá el verde", descripcion: "Tocá apenas el círculo se ponga verde.",
    beneficio: "El tiempo de reacción simple —cuánto tarda el cuerpo en responder a una señal— es una de las medidas más antiguas y estudiadas en psicología experimental.",
    categoria: "reflejos", edadMin: 7, dificultad: "facil", duracion: "2-3 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-espera-el-azul", nombre: "Esperá el azul", descripcion: "Tocá apenas el círculo se ponga azul.",
    beneficio: "Reaccionar a una señal visual simple, sin distractores, mide el tiempo de reacción puro: la velocidad básica de respuesta del sistema nervioso.",
    categoria: "reflejos", edadMin: 7, dificultad: "facil", duracion: "2-3 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-toca-el-amarillo", nombre: "Tocá el amarillo", descripcion: "Tocá apenas el círculo se ponga amarillo.",
    beneficio: "El entrenamiento del tiempo de reacción, aunque simple, mejora con la práctica: el cerebro se vuelve más eficiente detectando y respondiendo a la misma señal.",
    categoria: "reflejos", edadMin: 6, dificultad: "facil", duracion: "2-3 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-solo-el-verde", nombre: "Sólo el verde", descripcion: "Tocá sólo cuando aparezca el verde, no el rojo.",
    beneficio: "Distinguir cuándo actuar y cuándo no, frente a dos estímulos parecidos, entrena el control inhibitorio: frenar una respuesta automática cuando no corresponde.",
    categoria: "reflejos", edadMin: 9, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-solo-el-azul", nombre: "Sólo el azul", descripcion: "Tocá sólo cuando aparezca el azul, no el naranja.",
    beneficio: "El control inhibitorio —resistir el impulso de tocar cualquier estímulo— es una de las funciones ejecutivas más entrenables con la práctica repetida.",
    categoria: "reflejos", edadMin: 9, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-solo-el-violeta", nombre: "Sólo el violeta", descripcion: "Tocá sólo cuando aparezca el violeta, no el amarillo.",
    beneficio: "Frenar el impulso de tocar un color parecido pero incorrecto entrena la misma habilidad que se usa para no reaccionar por impulso en la vida diaria.",
    categoria: "reflejos", edadMin: 9, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-evita-el-rojo", nombre: "Evitá el rojo", descripcion: "Tocá el turquesa, pero nunca el rojo.",
    beneficio: "Evitar tocar un color específico, en vez de solo buscar uno, invierte la lógica habitual y entrena la atención de otra forma.",
    categoria: "reflejos", edadMin: 9, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-el-color-correcto", nombre: "El color correcto", descripcion: "Tocá el rosa, ignorá el gris.",
    beneficio: "Elegir el estímulo correcto entre dos parecidos entrena la discriminación visual además del tiempo de reacción.",
    categoria: "reflejos", edadMin: 8, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-toca-rapido", nombre: "Tocá rápido", descripcion: "Una versión más corta y rápida del clásico juego de reflejos.",
    beneficio: "Sesiones cortas de tiempo de reacción son suficientes para notar mejoras: no hace falta una ronda larga para entrenar esta habilidad.",
    categoria: "reflejos", edadMin: 6, dificultad: "facil", duracion: "1-2 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-el-semaforo", nombre: "El semáforo", descripcion: "Como un semáforo: tocá en verde, nunca en rojo.",
    beneficio: "El semáforo es una metáfora útil y conocida para el control inhibitorio: verde significa actuar, rojo significa frenar el impulso.",
    categoria: "reflejos", edadMin: 8, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-el-guardian", nombre: "El guardián", descripcion: "Sólo dejá pasar (tocá) el color amigo, no el color enemigo.",
    beneficio: "Aplicar una regla de 'aceptar o rechazar' según un criterio simple entrena el filtrado activo de estímulos, una habilidad usada constantemente al procesar información.",
    categoria: "reflejos", edadMin: 9, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-cuenta-y-toca", nombre: "Ronda larga de reflejos", descripcion: "Una ronda más larga para poner a prueba tu constancia.",
    beneficio: "Sostener un buen tiempo de reacción durante muchas rondas seguidas, sin que se degrade, mide algo distinto de la velocidad pura: la constancia atencional.",
    categoria: "reflejos", edadMin: 8, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-cronometro-personal", nombre: "Tu cronómetro personal", descripcion: "Medí tu tiempo de reacción promedio.",
    beneficio: "Conocer el propio tiempo de reacción promedio (que ronda los 200 a 300 milisegundos en adultos sanos) permite comparar el progreso propio con el tiempo, no con otras personas.",
    categoria: "reflejos", edadMin: 7, dificultad: "facil", duracion: "2-3 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-precision-o-velocidad", nombre: "Precisión o velocidad", descripcion: "Tocá el naranja, evitá el celeste: la calma también importa.",
    beneficio: "Ir demasiado rápido sin control aumenta los errores; este juego entrena el equilibrio entre velocidad y precisión, no solo la velocidad pura.",
    categoria: "reflejos", edadMin: 9, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "reflejos-alerta-maxima", nombre: "Alerta máxima", descripcion: "Una ronda larga y exigente de control de impulsos.",
    beneficio: "Sostener el control inhibitorio durante una serie larga de estímulos, sin cansarse ni perder precisión, es un desafío mayor que hacerlo solo un par de veces.",
    categoria: "reflejos", edadMin: 10, dificultad: "profundo", duracion: "4-6 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "atencion-vigilancia-de-color", nombre: "Vigilancia de color", descripcion: "Un clásico test de atención sostenida: tocá sólo el color correcto.",
    beneficio: "Las 'tareas de vigilancia' son un método real usado en psicología cognitiva para medir la atención sostenida: la capacidad de mantener el foco durante un período, no solo un instante.",
    categoria: "atencion", edadMin: 10, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "atencion-no-te-distraigas", nombre: "No te distraigas", descripcion: "Un distractor parecido va a aparecer seguido: no caigas.",
    beneficio: "Resistir un distractor que se parece al estímulo objetivo es más difícil que resistir uno muy distinto: entrena la atención selectiva fina.",
    categoria: "atencion", edadMin: 10, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "atencion-mantene-el-foco", nombre: "Mantené el foco", descripcion: "Una ronda larga para entrenar la atención sostenida en el tiempo.",
    beneficio: "Mantener el mismo nivel de atención durante una tarea larga y repetitiva, sin bajar el rendimiento, es justamente lo que mide la atención sostenida.",
    categoria: "atencion", edadMin: 10, dificultad: "media", duracion: "4-6 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "atencion-doble-chequeo", nombre: "Doble chequeo", descripcion: "Verificá bien el color antes de actuar.",
    beneficio: "Chequear dos veces antes de actuar, en vez de reaccionar al primer impulso, reduce errores en tareas donde la precisión importa más que la velocidad.",
    categoria: "atencion", edadMin: 9, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "atencion-alerta-selectiva", nombre: "Alerta selectiva", descripcion: "Filtrá el ruido visual y quedate sólo con lo importante.",
    beneficio: "La atención selectiva es la capacidad de enfocarse en un estímulo relevante ignorando otros presentes al mismo tiempo, como filtrar una voz en medio del ruido.",
    categoria: "atencion", edadMin: 10, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "flexibilidad-cambia-el-objetivo", nombre: "Cambia el objetivo", descripcion: "La regla cambia a mitad de partida: primero verde, después azul.",
    beneficio: "Cambiar de regla en medio de una tarea, sin previo aviso salvo el anuncio del cambio, es exactamente lo que mide la flexibilidad cognitiva en pruebas neuropsicológicas reales.",
    categoria: "flexibilidad", edadMin: 10, dificultad: "profundo", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "flexibilidad-nueva-regla-de-golpe", nombre: "Nueva regla, de golpe", descripcion: "Primero tocá rojo, después la regla cambia a amarillo.",
    beneficio: "El costo de cambiar de regla (un instante de lentitud justo después del cambio) es medible y esperable: notarlo en uno mismo ya es un acto de atención.",
    categoria: "flexibilidad", edadMin: 10, dificultad: "profundo", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "flexibilidad-adaptate-rapido", nombre: "Adaptate rápido", descripcion: "De violeta a naranja: cambiá de regla sin perder el ritmo.",
    beneficio: "Adaptarse rápido a una regla nueva, sin quedarse pegado a la anterior, es una habilidad que se entrena y que declina notablemente si no se practica.",
    categoria: "flexibilidad", edadMin: 11, dificultad: "profundo", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "flexibilidad-el-cambio-de-mitad-de-partida", nombre: "El cambio de mitad de partida", descripcion: "De turquesa a rosa: la regla cambia justo a la mitad.",
    beneficio: "La flexibilidad cognitiva —cambiar de estrategia cuando la situación lo requiere— es una de las tres funciones ejecutivas centrales, junto con la memoria de trabajo y el control inhibitorio.",
    categoria: "flexibilidad", edadMin: 11, dificultad: "profundo", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "flexibilidad-regla-inesperada", nombre: "Regla inesperada", descripcion: "De gris (esperá cualquier color) a un color específico: celeste.",
    beneficio: "Cuando una regla conocida deja de aplicar y hay que aprender una nueva sobre la marcha, el cerebro necesita 'soltar' la anterior antes de poder usar la nueva con fluidez.",
    categoria: "flexibilidad", edadMin: 11, dificultad: "profundo", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "flexibilidad-de-un-color-a-otro", nombre: "De un color a otro", descripcion: "Empezá con amarillo, terminá con violeta.",
    beneficio: "Practicar cambios de regla de forma repetida, con distintos colores cada vez, generaliza la habilidad de flexibilidad más allá de un solo par de reglas memorizado.",
    categoria: "flexibilidad", edadMin: 10, dificultad: "profundo", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "flexibilidad-el-giro-de-la-partida", nombre: "El giro de la partida", descripcion: "Una ronda larga con un cambio de regla a mitad de camino.",
    beneficio: "Sostener una regla nueva durante varias rondas después del cambio, sin volver por error a la regla anterior, es lo más difícil de la flexibilidad cognitiva.",
    categoria: "flexibilidad", edadMin: 11, dificultad: "profundo", duracion: "4-6 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/reaccion-tematica.js" },

  { id: "vinculos-disculpas-genuinas", nombre: "Disculpas genuinas", descripcion: "Reconocé qué hace que una disculpa sea real.",
    beneficio: "Una disculpa efectiva suele incluir reconocer lo que pasó, hacerse cargo, y mostrar intención de cambio, no sólo decir la palabra perdón.",
    categoria: "vinculos", edadMin: 12, dificultad: "media", duracion: "3-5 min",
    tipo: "individual", movil: true, puntuable: true, logros: true, disponible: true,
    archivo: "js/juegos/trivia-tematica.js" },
];
