...
const ACTIVIDADES = [
  ...
  // ═══════ 🚀 9-12 AÑOS (parte 2) ═══════
  { id: "silogismos-simples", titulo: "Pequeños silogismos", descripcion: "Razoná paso a paso para llegar a la conclusión correcta.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "logica", tipo: "seleccion", duracion: 4,
    contenido: {"rondas": [{"pregunta": "Todos los perros son animales. Rex es un perro. ¿Rex es un animal?", "opciones": ["Sí", "No", "No se puede saber"], "correctaIdx": 0}, {"pregunta": "Todas las aves vuelan. El pingüino es un ave. ¿El pingüino vuela?", "opciones": ["No (esta regla tiene excepciones)", "Sí, siempre", "No se puede saber"], "correctaIdx": 0}, {"pregunta": "Si llueve, el piso se moja. El piso está mojado. ¿Necesariamente llovió?", "opciones": ["No, podría haber otra causa", "Sí, seguro", "Es imposible que llueva"], "correctaIdx": 0}, {"pregunta": "Todos los cuadrados tienen 4 lados. Esta figura tiene 4 lados. ¿Es un cuadrado?", "opciones": ["No necesariamente (podría ser otro cuadrilátero)", "Sí, siempre", "No tiene lados"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "problemas-matematicos-simples", titulo: "Problemas para pensar", descripcion: "Resolvé estos problemas paso a paso.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "logica", tipo: "seleccion", duracion: 5,
    contenido: {"rondas": [{"pregunta": "Tenés 15 caramelos y repartís 3 a cada amigo. ¿A cuántos amigos les diste caramelos?", "opciones": ["5", "3", "12"], "correctaIdx": 0}, {"pregunta": "Un tren sale a las 3:00 y el viaje dura 2 horas. ¿A qué hora llega?", "opciones": ["5:00", "4:00", "6:00"], "correctaIdx": 0}, {"pregunta": "Si un libro cuesta $200 y tenés $650, ¿cuántos libros podés comprar?", "opciones": ["3", "2", "4"], "correctaIdx": 0}, {"pregunta": "Tenías 20 figuritas, perdiste 7 y ganaste 5. ¿Cuántas tenés ahora?", "opciones": ["18", "15", "22"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "el-misterio-de-la-ventana-rota", titulo: "El misterio de la ventana rota", descripcion: "Investigá quién rompió la ventana del gimnasio.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "logica", tipo: "historia", duracion: 5,
    contenido: {"inicio": "inicio", "nodos": {"inicio": {"texto": "La ventana del gimnasio apareció rota una mañana. Había una pelota de fútbol cerca, pero también restos de una rama de árbol. ¿Qué investigás primero?", "opciones": [{"texto": "Preguntar quién jugó ahí el día anterior", "siguiente": "jugadores"}, {"texto": "Revisar si había viento fuerte esa noche", "siguiente": "clima"}]}, "jugadores": {"texto": "Un grupo había jugado al fútbol esa tarde, pero terminaron antes de que oscureciera. La ventana se rompió de noche, según el portero.", "opciones": [{"texto": "Revisar el clima de esa noche", "siguiente": "clima"}]}, "clima": {"texto": "Esa noche hubo una tormenta muy fuerte con viento. Una rama grande del árbol de al lado estaba quebrada, justo apuntando hacia la ventana. ¡Fue el viento, no la pelota! Caso resuelto.", "opciones": []}}},
    activo: true, version: 1 },

  { id: "quien-tomo-el-libro", titulo: "¿Quién se llevó el libro?", descripcion: "Un libro de la biblioteca desapareció. Investigá.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "logica", tipo: "historia", duracion: 5,
    contenido: {"inicio": "inicio", "nodos": {"inicio": {"texto": "El libro más pedido de la biblioteca desapareció del estante. La bibliotecaria dice que tres chicos lo estuvieron mirando esa semana. ¿Por dónde empezás?", "opciones": [{"texto": "Revisar el registro de préstamos", "siguiente": "registro"}, {"texto": "Preguntarles directamente a los tres", "siguiente": "preguntar"}]}, "registro": {"texto": "El registro muestra que nadie lo pidió prestado oficialmente. Eso significa que alguien se lo llevó sin anotarlo, o está mal ubicado en otro estante.", "opciones": [{"texto": "Revisar los estantes cercanos", "siguiente": "estante"}]}, "preguntar": {"texto": "Dos de los tres dicen que solo lo miraron ahí. El tercero admite que lo estaba leyendo y lo dejó en otro estante sin querer.", "opciones": [{"texto": "Revisar los estantes cercanos", "siguiente": "estante"}]}, "estante": {"texto": "El libro aparece mal ubicado, en el estante de al lado. No había ningún misterio real: solo alguien que lo devolvió en el lugar equivocado. Caso resuelto.", "opciones": []}}},
    activo: true, version: 1 },

  { id: "clasificar-numeros-primos", titulo: "Números primos o no", descripcion: "Clasificá cada número según si es primo o no.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "logica", tipo: "clasificar", duracion: 5,
    contenido: {"instruccion": "¿Es un número primo?", "grupoA": {"nombre": "Primo", "emoji": "✅"}, "grupoB": {"nombre": "No primo", "emoji": "❌"}, "items": [{"emoji": "2️⃣", "grupo": "A"}, {"emoji": "4️⃣", "grupo": "B"}, {"emoji": "3️⃣", "grupo": "A"}, {"emoji": "6️⃣", "grupo": "B"}, {"emoji": "5️⃣", "grupo": "A"}, {"emoji": "8️⃣", "grupo": "B"}, {"emoji": "7️⃣", "grupo": "A"}, {"emoji": "9️⃣", "grupo": "B"}, {"emoji": "1️⃣1️⃣", "grupo": "A"}, {"emoji": "1️⃣0️⃣", "grupo": "B"}]},
    activo: true, version: 1 },

  { id: "analogias-simples", titulo: "Analogías", descripcion: "A es a B como C es a... Completá la analogía.",
    beneficio: "Las analogías (A es a B como C es a...) entrenan el razonamiento relacional, una habilidad muy ligada al pensamiento lógico-matemático.",
    edadMin: 9, edadMax: 12, categoria: "logica", tipo: "seleccion", duracion: 5,
    contenido: {"rondas": [{"pregunta": "Pájaro es a nido como abeja es a...", "opciones": ["🍯 Colmena", "🕸️ Telaraña", "🏠 Casa"], "correctaIdx": 0}, {"pregunta": "Día es a sol como noche es a...", "opciones": ["🌙 Luna", "☀️ Sol", "🌈 Arcoíris"], "correctaIdx": 0}, {"pregunta": "Libro es a leer como música es a...", "opciones": ["🎧 Escuchar", "👀 Mirar", "🏃 Correr"], "correctaIdx": 0}, {"pregunta": "Pez es a agua como pájaro es a...", "opciones": ["💨 Aire", "🌍 Tierra", "🔥 Fuego"], "correctaIdx": 0}, {"pregunta": "Frío es a caliente como oscuro es a...", "opciones": ["💡 Claro/luminoso", "🌙 Noche", "⚫ Negro"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "carta-a-mi-yo-del-futuro-infantil", titulo: "Carta a tu yo del futuro", descripcion: "Escribile una carta a la versión de vos de dentro de diez años.",
    beneficio: "Escribir historias inventadas, sin una única respuesta correcta, le da a los chicos espacio para experimentar con ideas propias sin miedo a equivocarse.",
    edadMin: 9, edadMax: 12, categoria: "creatividad", tipo: "escritura", duracion: 5,
    contenido: {"pregunta": "Escribile una carta a la versión de vos de dentro de diez años. ¿Qué te gustaría contarle o preguntarle?", "placeholder": "Querido yo del futuro…"},
    activo: true, version: 1 },

  { id: "inventa-un-mundo-infantil", titulo: "Inventá un mundo", descripcion: "Inventá un planeta o mundo completamente nuevo.",
    beneficio: "Escribir historias inventadas, sin una única respuesta correcta, le da a los chicos espacio para experimentar con ideas propias sin miedo a equivocarse.",
    edadMin: 9, edadMax: 12, categoria: "creatividad", tipo: "escritura", duracion: 5,
    contenido: {"pregunta": "Inventá un planeta o mundo completamente nuevo. ¿Cómo es, quién vive ahí, y qué reglas tiene?", "placeholder": "En este mundo…"},
    activo: true, version: 1 },

  { id: "el-objeto-magico", titulo: "El objeto mágico", descripcion: "Inventá un objeto con un poder mágico y contá su historia.",
    beneficio: "Escribir historias inventadas, sin una única respuesta correcta, le da a los chicos espacio para experimentar con ideas propias sin miedo a equivocarse.",
    edadMin: 9, edadMax: 12, categoria: "creatividad", tipo: "escritura", duracion: 5,
    contenido: {"pregunta": "Inventá un objeto que tenga un poder mágico. ¿Qué hace, y cómo lo conseguiste?", "placeholder": "El objeto es…"},
    activo: true, version: 1 },

  { id: "dibuja-un-invento", titulo: "Dibujá un invento", descripcion: "Inventá una máquina que resuelva un problema cotidiano.",
    beneficio: "Escribir historias inventadas, sin una única respuesta correcta, le da a los chicos espacio para experimentar con ideas propias sin miedo a equivocarse.",
    edadMin: 9, edadMax: 12, categoria: "creatividad", tipo: "dibujo", duracion: 5,
    contenido: {"texto": "Inventá una máquina que resuelva algún problema cotidiano. Dibujala y pensá cómo funciona."},
    activo: true, version: 1 },

  { id: "cambia-el-final-de-un-cuento", titulo: "Cambiá el final de un cuento", descripcion: "Elegí un cuento conocido e inventale un final distinto.",
    beneficio: "Escribir historias inventadas, sin una única respuesta correcta, le da a los chicos espacio para experimentar con ideas propias sin miedo a equivocarse.",
    edadMin: 9, edadMax: 12, categoria: "creatividad", tipo: "escritura", duracion: 5,
    contenido: {"pregunta": "Elegí un cuento que conozcas bien (Caperucita, Los tres chanchitos, el que quieras) e inventale un final completamente distinto.", "placeholder": "En mi versión, el final es…"},
    activo: true, version: 1 },

  { id: "escribi-sobre-un-miedo", titulo: "Escribí sobre un miedo", descripcion: "Contá algo que te da miedo y qué harías para sentirte mejor.",
    beneficio: "Reconocer emociones más complejas, como los celos, el orgullo o la culpa, amplía el vocabulario emocional más allá de las emociones básicas de la primera infancia.",
    edadMin: 9, edadMax: 12, categoria: "emociones", tipo: "escritura", duracion: 5,
    contenido: {"pregunta": "Contá algo que te da un poco de miedo, y qué cosas te ayudarían a sentirte mejor con eso.", "placeholder": "Algo que me da miedo es…"},
    activo: true, version: 1 },

  { id: "reconocer-emociones-complejas", titulo: "Emociones más complejas", descripcion: "Reconocé emociones que no son tan simples como alegría o tristeza.",
    beneficio: "Reconocer emociones más complejas, como los celos, el orgullo o la culpa, amplía el vocabulario emocional más allá de las emociones básicas de la primera infancia.",
    edadMin: 9, edadMax: 12, categoria: "emociones", tipo: "seleccion", duracion: 5,
    contenido: {"rondas": [{"pregunta": "Tu amigo ganó un premio que vos también querías. Estás contento por él, pero también te cuesta un poco. ¿Qué emoción es esta mezcla?", "opciones": ["Celos mezclados con alegría", "Solo tristeza", "Solo alegría"], "correctaIdx": 0}, {"pregunta": "Hiciste algo que sabías que no debías hacer. ¿Qué emoción es la que sentís cuando te das cuenta?", "opciones": ["Culpa", "Sorpresa", "Aburrimiento"], "correctaIdx": 0}, {"pregunta": "Lograste algo después de mucho esfuerzo. ¿Qué emoción sentís, más allá de la alegría?", "opciones": ["Orgullo", "Vergüenza", "Aburrimiento"], "correctaIdx": 0}, {"pregunta": "Alguien te comparó todo el tiempo con tu hermano. ¿Qué emoción podría aparecer?", "opciones": ["Frustración", "Alegría pura", "Calma total"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "carta-a-un-amigo-imaginario", titulo: "Carta a un amigo imaginario", descripcion: "Escribile a un amigo imaginario contándole cómo estás.",
    beneficio: "Reconocer emociones más complejas, como los celos, el orgullo o la culpa, amplía el vocabulario emocional más allá de las emociones básicas de la primera infancia.",
    edadMin: 9, edadMax: 12, categoria: "emociones", tipo: "escritura", duracion: 5,
    contenido: {"pregunta": "Escribile una carta corta a un amigo imaginario, contándole cómo te sentís hoy y por qué.", "placeholder": "Querido amigo imaginario…"},
    activo: true, version: 1 },

  { id: "dilemas-simples", titulo: "Dilemas para pensar", descripcion: "No hay una sola respuesta correcta: pensá qué harías.",
    beneficio: "Pensar en dilemas con más de una respuesta posible ayuda a desarrollar el razonamiento moral, una habilidad que sigue madurando durante toda la adolescencia.",
    edadMin: 9, edadMax: 12, categoria: "social", tipo: "seleccion", duracion: 5,
    contenido: {"rondas": [{"pregunta": "Encontrás dinero en el patio de la escuela. ¿Qué te parece mejor?", "opciones": ["Entregarlo a un adulto", "Guardarlo", "Ignorarlo"], "correctaIdx": 0}, {"pregunta": "Un amigo te pide que le copies la tarea. ¿Qué le decís?", "opciones": ["Prefiero ayudarte a entenderla", "Se la doy sin más", "Le digo que no y ya"], "correctaIdx": 0}, {"pregunta": "Ves que están tratando mal a alguien, pero da miedo intervenir. ¿Qué es lo mejor?", "opciones": ["Buscar ayuda de un adulto", "Mirar para otro lado", "Sumarme"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "el-rumor", titulo: "El rumor", descripcion: "Una historia sobre cómo se esparce un rumor.",
    beneficio: "Pensar en dilemas con más de una respuesta posible ayuda a desarrollar el razonamiento moral, una habilidad que sigue madurando durante toda la adolescencia.",
    edadMin: 9, edadMax: 12, categoria: "social", tipo: "historia", duracion: 5,
    contenido: {"inicio": "inicio", "nodos": {"inicio": {"texto": "Escuchás un rumor sobre un compañero que no sabés si es verdad. ¿Qué hacés?", "opciones": [{"texto": "Preguntarle directamente a esa persona", "siguiente": "pregunta"}, {"texto": "Contárselo a otros compañeros", "siguiente": "cuenta"}]}, "pregunta": {"texto": "Le preguntás directamente y resulta que el rumor era falso, alguien lo había malentendido. Evitaste que se siguiera esparciendo algo que no era cierto.", "opciones": []}, "cuenta": {"texto": "El rumor se esparce rápido, y resulta que era falso. Tu compañero se entera y se siente mal por lo que se dijo sin comprobar. Aprendiste que conviene chequear antes de repetir algo.", "opciones": []}}},
    activo: true, version: 1 },

  { id: "trabajo-en-equipo", titulo: "Trabajo en equipo", descripcion: "Elegí la mejor forma de trabajar con otros en un proyecto.",
    beneficio: "Pensar en dilemas con más de una respuesta posible ayuda a desarrollar el razonamiento moral, una habilidad que sigue madurando durante toda la adolescencia.",
    edadMin: 9, edadMax: 12, categoria: "social", tipo: "seleccion", duracion: 3,
    contenido: {"rondas": [{"pregunta": "Un compañero de grupo no está haciendo su parte. ¿Qué es mejor?", "opciones": ["Hablarlo con el grupo, sin acusar", "Hacer todo vos sin decir nada", "Quejarte a espaldas de él"], "correctaIdx": 0}, {"pregunta": "Dos personas del grupo tienen ideas distintas. ¿Qué es mejor?", "opciones": ["Escuchar las dos y buscar un punto medio", "Que gane el que grita más fuerte", "Hacer cada uno lo suyo"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "detective-de-numeros", titulo: "Detective de números", descripcion: "Encontrá el número que no sigue la regla.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "atencion", tipo: "seleccion", duracion: 5,
    contenido: {"rondas": [{"pregunta": "2, 4, 6, 9, 8. ¿Cuál no sigue la regla de los pares?", "opciones": ["9", "2", "4"], "correctaIdx": 0}, {"pregunta": "5, 10, 15, 21, 25. ¿Cuál no sigue la regla de sumar 5?", "opciones": ["21", "5", "10"], "correctaIdx": 0}, {"pregunta": "1, 4, 9, 15, 16. ¿Cuál no es un cuadrado perfecto (1, 4, 9, 16, 25)?", "opciones": ["15", "1", "4"], "correctaIdx": 0}, {"pregunta": "3, 6, 9, 13, 12. ¿Cuál no sigue la regla de los múltiplos de 3?", "opciones": ["13", "3", "6"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "encuentra-el-patron-escondido", titulo: "El patrón escondido", descripcion: "Descubrí la regla que conecta estos números.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "atencion", tipo: "seleccion", duracion: 4,
    contenido: {"rondas": [{"pregunta": "1, 1, 2, 3, 5, 8, ¿qué sigue? (cada número es la suma de los dos anteriores)", "opciones": ["13", "10", "12"], "correctaIdx": 0}, {"pregunta": "2, 6, 18, 54, ¿qué sigue? (cada número se multiplica por 3)", "opciones": ["162", "108", "150"], "correctaIdx": 0}, {"pregunta": "100, 90, 80, 70, ¿qué sigue?", "opciones": ["60", "50", "65"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "memoria-capitales", titulo: "Memoria de capitales", descripcion: "Encontrá las parejas de país y su bandera.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "memoria", tipo: "memoria", duracion: 6,
    contenido: {"pares": ["🇦🇷", "🇫🇷", "🇯🇵", "🇪🇬", "🇮🇳", "🇨🇦", "🇮🇹"]},
    activo: true, version: 1 },

  { id: "memoria-banderas-del-mundo", titulo: "Memoria de banderas del mundo", descripcion: "Un desafío grande de memoria con banderas.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "memoria", tipo: "memoria", duracion: 6,
    contenido: {"pares": ["🇩🇪", "🇪🇸", "🇬🇧", "🇰🇷", "🇿🇦", "🇦🇺", "🇳🇴"]},
    activo: true, version: 1 },

  { id: "respiracion-4-7-8-para-chicos", titulo: "Respiración 4-7-8", descripcion: "Una técnica real para calmarte antes de algo importante.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "calma", tipo: "respiracion", duracion: 3,
    contenido: {"texto": "Inhalá contando 4, sostené contando 7, exhalá contando 8. Repetilo unas cuantas veces 🌬️", "ciclos": 4, "fases": [{"nombre": "Inhalá contando hasta 4", "segundos": 4}, {"nombre": "Sostené contando hasta 7", "segundos": 7}, {"nombre": "Exhalá contando hasta 8", "segundos": 8}]},
    activo: true, version: 1 },

  { id: "pausa-mental-de-un-minuto", titulo: "Pausa mental de un minuto", descripcion: "Un minuto entero solo para respirar y estar.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "calma", tipo: "respiracion", duracion: 2,
    contenido: {"texto": "Durante un minuto, no tenés que hacer nada más que respirar y estar acá 🧘", "ciclos": 5, "fases": [{"nombre": "Inhalá", "segundos": 5}, {"nombre": "Exhalá", "segundos": 7}]},
    activo: true, version: 1 },

  { id: "secuencias-numericas-avanzadas", titulo: "Secuencias numéricas avanzadas", descripcion: "Descubrí patrones numéricos más complejos.",
    beneficio: "Las analogías (A es a B como C es a...) entrenan el razonamiento relacional, una habilidad muy ligada al pensamiento lógico-matemático.",
    edadMin: 9, edadMax: 12, categoria: "secuencias", tipo: "seleccion", duracion: 4,
    contenido: {"rondas": [{"pregunta": "1, 4, 9, 16, ¿qué sigue? (números al cuadrado: 1x1, 2x2, 3x3, 4x4...)", "opciones": ["25", "20", "24"], "correctaIdx": 0}, {"pregunta": "2, 4, 8, 16, ¿qué sigue? (se duplica cada vez)", "opciones": ["32", "24", "30"], "correctaIdx": 0}, {"pregunta": "1, 3, 6, 10, ¿qué sigue? (se suma uno más cada vez: +2, +3, +4, +5)", "opciones": ["15", "13", "14"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "ordena-el-proceso-cientifico", titulo: "El proceso científico", descripcion: "Ordená los pasos del método científico.",
    beneficio: "Clasificar el mundo natural en categorías más precisas (vertebrados/invertebrados, renovable/no renovable) es una base del pensamiento científico que se profundiza en esta edad.",
    edadMin: 9, edadMax: 12, categoria: "secuencias", tipo: "secuencia", duracion: 5,
    contenido: {"instruccion": "Ordená los pasos del método científico.", "items": ["Hacer una pregunta", "Formular una hipótesis", "Diseñar un experimento", "Analizar los resultados", "Sacar una conclusión"]},
    activo: true, version: 1 },

  { id: "la-decision-dificil", titulo: "La decisión difícil", descripcion: "Una historia sobre elegir entre dos cosas que importan.",
    beneficio: "Pensar en dilemas con más de una respuesta posible ayuda a desarrollar el razonamiento moral, una habilidad que sigue madurando durante toda la adolescencia.",
    edadMin: 9, edadMax: 12, categoria: "historias", tipo: "historia", duracion: 5,
    contenido: {"inicio": "inicio", "nodos": {"inicio": {"texto": "Tenés un partido de fútbol muy importante el mismo día que el cumpleaños de tu mejor amigo. No podés ir a los dos. ¿Qué hacés?", "opciones": [{"texto": "Ir al partido y explicarle a tu amigo después", "siguiente": "partido"}, {"texto": "Ir al cumpleaños y avisar en el equipo", "siguiente": "cumple"}, {"texto": "Intentar ir a los dos, aunque sea un rato a cada uno", "siguiente": "ambos"}]}, "partido": {"texto": "Vas al partido y le explicás a tu amigo después. Él entiende, pero te cuenta que lo extrañó ese día. Aprendés que avisar con tiempo ayuda a que el otro no se sorprenda.", "opciones": []}, "cumple": {"texto": "Vas al cumpleaños y avisás en el equipo con anticipación. Tu amigo se pone muy contento de que hayas priorizado estar ahí, y el equipo entiende tu ausencia.", "opciones": []}, "ambos": {"texto": "Lográs ir un rato a cada uno, aunque termines agotado. Los dos se ponen contentos de verte, aunque sea poco tiempo. A veces un esfuerzo extra vale la pena.", "opciones": []}}},
    activo: true, version: 1 },

  { id: "clasificar-vertebrados-invertebrados", titulo: "Vertebrados o invertebrados", descripcion: "Clasificá cada animal según si tiene columna vertebral.",
    beneficio: "Clasificar el mundo natural en categorías más precisas (vertebrados/invertebrados, renovable/no renovable) es una base del pensamiento científico que se profundiza en esta edad.",
    edadMin: 9, edadMax: 12, categoria: "clasificacion", tipo: "clasificar", duracion: 5,
    contenido: {"instruccion": "¿Es vertebrado o invertebrado?", "grupoA": {"nombre": "Vertebrado", "emoji": "🦴"}, "grupoB": {"nombre": "Invertebrado", "emoji": "🐛"}, "items": [{"emoji": "🐶", "grupo": "A"}, {"emoji": "🐜", "grupo": "B"}, {"emoji": "🐟", "grupo": "A"}, {"emoji": "🦋", "grupo": "B"}, {"emoji": "🦅", "grupo": "A"}, {"emoji": "🕷️", "grupo": "B"}, {"emoji": "🐍", "grupo": "A"}, {"emoji": "🐌", "grupo": "B"}, {"emoji": "🐸", "grupo": "A"}, {"emoji": "🦀", "grupo": "B"}]},
    activo: true, version: 1 },

  { id: "clasificar-renovable-no-renovable", titulo: "Recursos renovables o no", descripcion: "Clasificá cada recurso según si se renueva o no.",
    beneficio: "Clasificar el mundo natural en categorías más precisas (vertebrados/invertebrados, renovable/no renovable) es una base del pensamiento científico que se profundiza en esta edad.",
    edadMin: 9, edadMax: 12, categoria: "clasificacion", tipo: "clasificar", duracion: 4,
    contenido: {"instruccion": "¿Es un recurso renovable o no renovable?", "grupoA": {"nombre": "Renovable", "emoji": "♻️"}, "grupoB": {"nombre": "No renovable", "emoji": "⛽"}, "items": [{"emoji": "☀️", "grupo": "A"}, {"emoji": "🛢️", "grupo": "B"}, {"emoji": "💨", "grupo": "A"}, {"emoji": "⛏️", "grupo": "B"}, {"emoji": "💧", "grupo": "A"}, {"emoji": "⚫", "grupo": "B"}, {"emoji": "🌳", "grupo": "A"}, {"emoji": "💎", "grupo": "B"}]},
    activo: true, version: 1 },

  { id: "acertijos-matematicos", titulo: "Acertijos matemáticos", descripcion: "Resolvé estos acertijos usando lógica.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "logica", tipo: "seleccion", duracion: 4,
    contenido: {"rondas": [{"pregunta": "Soy un número: si me duplicás y le restás 4, da 10. ¿Qué número soy?", "opciones": ["7", "6", "8"], "correctaIdx": 0}, {"pregunta": "Tres amigos se reparten 12 caramelos en partes iguales. ¿Cuántos le tocan a cada uno?", "opciones": ["4", "3", "6"], "correctaIdx": 0}, {"pregunta": "Si hoy es miércoles, ¿qué día será dentro de 10 días?", "opciones": ["Sábado", "Viernes", "Domingo"], "correctaIdx": 0}]},
    activo: true, version: 1 },

  { id: "que-pasaria-si-animales-hablaran", titulo: "Si los animales hablaran", descripcion: "Escribí qué pasaría si de golpe los animales pudieran hablar.",
    beneficio: "Escribir historias inventadas, sin una única respuesta correcta, le da a los chicos espacio para experimentar con ideas propias sin miedo a equivocarse.",
    edadMin: 9, edadMax: 12, categoria: "creatividad", tipo: "escritura", duracion: 5,
    contenido: {"pregunta": "Imaginá que un día, de golpe, todos los animales pudieran hablar. ¿Qué pasaría? ¿Qué dirían?", "placeholder": "Si los animales hablaran…"},
    activo: true, version: 1 },

  { id: "el-detective-de-mentiras", titulo: "El detective de mentiras", descripcion: "Encontrá qué frase no encaja con las demás pistas.",
    beneficio: "Resolver un problema simple paso a paso ejercita la planificación, una de las funciones ejecutivas que más se desarrollan en esta etapa.",
    edadMin: 9, edadMax: 12, categoria: "atencion", tipo: "seleccion", duracion: 5,
    contenido: {"rondas": [{"pregunta": "Alguien dice: \"Estuve en casa toda la tarde, pero mis zapatillas están llenas de barro\". ¿Qué no encaja?", "opciones": ["El barro no encaja con haber estado en casa", "Todo encaja perfecto", "No hay ninguna pista"], "correctaIdx": 0}, {"pregunta": "Alguien dice: \"No vi el partido, pero sé el resultado exacto\". ¿Qué llama la atención?", "opciones": ["Sabe el resultado sin haberlo visto", "Nada llama la atención", "El partido no existió"], "correctaIdx": 0}, {"pregunta": "Alguien dice: \"Hace mucho que no como torta\", pero tiene la cara llena de crema. ¿Qué no encaja?", "opciones": ["La crema en la cara", "Nada, está todo bien", "La torta no tiene crema"], "correctaIdx": 0}]},
    activo: true, version: 1 },
];
